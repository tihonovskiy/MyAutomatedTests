...
import Rozetka.RozetkaComparisonPageObject;
import Rozetka.RozetkaHomePageObject;
import Rozetka.RozetkaProductDetailePageObject;
...
public class RozetkaVerificationOfComparisonTestObject {
    ...
    RozetkaProductDetailePageObject productDetailePage;
    RozetkaComparisonPageObject comparisonPage;
    ...
    public void verificationOfComparisonTest() {
        ...
        productDetailePage = new RozetkaProductDetailePageObject(driver);
        comparisonPage = new RozetkaComparisonPageObject(driver);
